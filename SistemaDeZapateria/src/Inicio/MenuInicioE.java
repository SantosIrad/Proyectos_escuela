...
public class MenuInicioE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("ZAPATERIA \"Nos conocemos\" - Vendedor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuInicioE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
